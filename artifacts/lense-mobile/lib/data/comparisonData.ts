...
// They represent elite-level performance profiles, not directly measured data.
...
export const PRO_ATHLETES: ProAthlete[] = [
  ...
  // ── SOCCER ────────────────────────────────────────────────────────────────
  {
    ...
    trainingPhilosophy: "Hard work beats talent. I was not born the best footballer — I became it through years of sacrifice. Every day I have to push myself, even when I don't want to. That is what separates professionals from amateurs.",
    sources: [
      { label: "Wikipedia — Cristiano Ronaldo", url: "https://en.wikipedia.org/wiki/Cristiano_Ronaldo" },
      { label: "Kellis & Katis (2007, J Sports Sci Med) — Instep kick biomechanics and ball velocity", url: "https://pubmed.ncbi.nlm.nih.gov/24149519/" },
      { label: "Nunome et al. (2002, Med Sci Sports Exerc) — Three-dimensional kicking kinematics", url: "https://pubmed.ncbi.nlm.nih.gov/12195181/" },
    ],
    trainTips: [
