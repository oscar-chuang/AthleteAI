...
// index.tsx imports the default export from @/components/ShareCard (the
// standalone home-screen card); @/components/analysis/ShareCard is used by
// the analysis detail screen and is kept separately below.
