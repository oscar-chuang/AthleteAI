    ...
    <View style={ss.root}>
      ...
      {isLandscape ? (
        ...
        >
          ...
          {/* ── Research note ── */}
          {modelReady && (
            <Text style={ss.researchNote}>
              Thresholds based on peer-reviewed biomechanics research (Escamilla 2001, Hewett 2005, Heiderscheit 2011). Not a medical diagnosis.
            </Text>
          )}
...
const ss = StyleSheet.create({
  ...
  researchNote:  { fontSize: 10, color: "#44445a", fontFamily: "Inter_400Regular", lineHeight: 14, paddingHorizontal: 18, paddingTop: 14, fontStyle: "italic" },
