              ...
              {showSources && (
                <View style={ss.sourcesCard}>
                  ...
                  <Text style={ss.sourcesSubheading}>
                    Joint angle thresholds and AI coaching tips are grounded in peer-reviewed sports science. Research is organized by sport and category. AI content is generated by Anthropic Claude — not a substitute for professional medical or coaching advice.
                  </Text>
                  ...
                  {([
                    ...
                    { ref: "Garhammer J.", year: "1993", title: "A review of power output studies of Olympic and powerlifting: methodology, performance prediction, and evaluation tests.", journal: "J Strength Cond Res", detail: "7(2):76–89" },
                  ...
                  {/* ── Running / Cycling ── */}
                  <Text style={[ss.sourcesGroupLabel, { color: "#6c63ffaa", marginTop: 14 }]}>⚡ Running · Cycling</Text>
                  {([
                  ...
                  {([
                    ...
                    { ref: "Sheppard JM et al.", year: "2008", title: "An evaluation of a new test of reactive agility and its relationship to sprint speed and change of direction speed.", journal: "J Strength Cond Res", detail: "22(4):1093–1099" },
                  ...
                  {/* ── Soccer / Football ── */}
                  <Text style={[ss.sourcesGroupLabel, { color: "#6c63ffaa", marginTop: 14 }]}>⚡ Soccer · Football</Text>
                  {([
                    ...
                    { ref: "Nunome H et al.", year: "2002", title: "Three-dimensional kinetic analysis of side-foot and instep soccer kicks.", journal: "Med Sci Sports Exerc", detail: "34(12):2028–2036" },
                  ...
                  {/* ── Tennis / Baseball ── */}
                  <Text style={[ss.sourcesGroupLabel, { color: "#6c63ffaa", marginTop: 14 }]}>⚡ Tennis · Baseball</Text>
                  {([
                  ...
                  {/* ── Swimming / Gymnastics ── */}
                  <Text style={[ss.sourcesGroupLabel, { color: "#6c63ffaa", marginTop: 14 }]}>⚡ Swimming · Gymnastics</Text>
                  {([
                    ...
                    { ref: "Mkaouer B et al.", year: "2013", title: "Relationship between body composition and gymnastic performance in female gymnasts.", journal: "Sci Sports", detail: "28(5–6):146–154" },
                  ] as const).map((s, i) => (
                    <View key={i} style={ss.sourceRow}>
                      <Text style={[ss.sourceNum, { color: "#6c63ff" }]}>{i + 1}</Text>
                      <View style={{ flex: 1 }}>
                  ...
                  {/* ── Cross-sport: Core & Kinetic Chain ── */}
                  <Text style={[ss.sourcesGroupLabel, { color: "#6c63ffaa", marginTop: 14 }]}>⚡ Core Stability & Kinetic Chain — All Sports</Text>
                  {([
