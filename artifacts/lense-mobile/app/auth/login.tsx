  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={[s.sub, { color: colors.textTertiary }]}>Sign in to continue your training</Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={[s.altBtnText, { color: colors.textPrimary }]}>Create an account</Text>
        </TouchableOpacity>
      </ScrollView>
    </KeyboardAvoidingView>
  );
